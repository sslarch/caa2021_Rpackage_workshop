...
Functions do not need a name: Lambda functions
...
Every object in a programming environment has some type. But R functions have no way to being explicit about this: Dynamic type system
